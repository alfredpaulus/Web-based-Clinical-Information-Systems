...
public partial class MasterPageCISLaboratories : System.Web.UI.MasterPage
{
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        //Security: This will check if the user was logged in and logged in as Nurse/MedTech, if not, it will redirect to another page
        if (Session["LoggedIn"] == null || Session["LoggedInAs"].ToString() != "NMT")
        {
