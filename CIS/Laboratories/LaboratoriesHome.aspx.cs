    ...
    protected void btnContinue_Click(object sender, EventArgs e)
    {
        ...
        if (tbPatientID.Text != null || ddlExam.Text != null)
        {
            ...
            using (SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["FortMedCISConnectionString"].ToString()))
            {
                ...
                {
                    Session["LaboratoryPatientID"] = tbPatientID.Text;
                    Session["LaboratoryPatientDoB"] = dataSet.Tables[0].Rows[0]["Bdate"].ToString();
                    Session["LaboratoryPatientName"] = dataSet.Tables[0].Rows[0]["Lname"].ToString() + ", " + dataSet.Tables[0].Rows[0]["Fname"].ToString() + " " + dataSet.Tables[0].Rows[0]["Mname"].ToString();
                    Session["LaboratoryPatientAge"] = dataSet.Tables[0].Rows[0]["Age"].ToString();
                    Session["LaboratoryPatientGender"] = dataSet.Tables[0].Rows[0]["Gender"].ToString();
                    Session["LaboratoryDateTime"] = System.DateTime.Now.ToString();
                    ...
                    //{
                    //    cn.Close();
                    //    Response.Redirect("~/CIS/Laboratories/LaboratoriesDental.aspx");
                    //}
                    ...
                    {
                        cn.Close();
                        Response.Redirect("~/CIS/Laboratories/LaboratoriesPhysical.aspx");
                    }
