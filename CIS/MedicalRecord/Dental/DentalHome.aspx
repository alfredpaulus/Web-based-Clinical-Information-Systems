<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageCISMedicalRecord.master" AutoEventWireup="true" CodeFile="DentalHome.aspx.cs" Inherits="CIS_Laboratories_LaboratoriesHome" %>
...
<%--                                                                <asp:ListItem Text="Vital Signs" Value="Vital Signs" Selected="True">Vital Signs</asp:ListItem>
                                                                ...
                                                                <asp:ListItem Text="Dental" Value="Dental" Selected="True">Dental</asp:ListItem>
