<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_CTScan.aspx.cs" Inherits="View_Reports_NurseMedtech_View_CTScan" %>
    ...
    <div>
       ...
       <center><b> FORT MED CLINICAL REPORTS</b></center><br />
        ...
        <center><rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="800px">
            <LocalReport ReportPath="Report_Designs\CTScan_Report.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource_CTScan" Name="DataSet_CTScan" />
                </DataSources>
            </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource_CTScan" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataCTScan" TypeName="LabReportCTScanTableAdapters.LabCTScanTableAdapter" UpdateMethod="Update">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="ClinicalDiag" Type="String" />
